# Generated by Django 5.2.11 on 2026-03-29 04:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_stage', models.CharField(choices=[('DEFINITION', 'Definition'), ('EXPLORATION', 'Exploration'), ('FORMULATION', 'Formulation'), ('COLLECTION', 'Collection'), ('PRESENTATION', 'Presentation')], default='DEFINITION', help_text='Current ISP phase (DEFINITION, EXPLORATION, etc.).', max_length=50)),
                ('is_active', models.BooleanField(default=True, help_text='Indicates if the project is currently in progress or concluded.')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(help_text='The ID of the user owning this project.', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('project', models.OneToOneField(help_text='One-to-one link to the parent ResearchProject (Control Model).', on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='exploration_data', serialize=False, to='projects.researchproject')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequence_number', models.IntegerField(help_text="The sequential order of the message within the project's history.")),
                ('project', models.ForeignKey(help_text='Foreign key linking the message to the parent research project session.', on_delete=django.db.models.deletion.CASCADE, related_name='chat_history_entries', to='projects.researchproject')),
            ],
            options={
